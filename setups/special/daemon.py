...
devices = dict(Auth = device('nicos.services.daemon.auth.list.Authenticator',
        hashing = 'md5',
        ...
        passwd = [('guest', '', 'guest'),
            # The entries for these password hashes are generated from
            # randomized
            # passwords and not reproduceable, please don't forget to create
            # new
            # ones.
